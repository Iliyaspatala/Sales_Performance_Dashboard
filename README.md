...
##Overview
Interactive Sales Performance Dashboard built using Power BI, analyzing 51,292 records across regions, categories and years.
...
Sales grew from 2011 to 2014 consistently
